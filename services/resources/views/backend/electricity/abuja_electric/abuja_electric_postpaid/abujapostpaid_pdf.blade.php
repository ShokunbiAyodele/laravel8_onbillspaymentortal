...
<tr>
    ...
    <td><h5>Electricity Payment Receipt</h5>
...
<table id="customers">
  ...
  <tr>
    <td>1</td>
    <td>Meter No</td>
    <td>{{  $pdf_details['accountNumber'] }}</td>
  </tr>
  <tr>
    <td>2</td>
    <td>Status</td>
  ...
  <tr>
    ...
    <td>{{ $pdf_details['date']}}</td>
  </tr>

  <!-- <tr>
    <td>7</td>
    <td>Credit Token</td>
    <td>{{ $pdf_details['creditToken']  }}</td>
  </tr> -->
  <tr>
    <td>8</td>
    <td>Message</td>
    <td>{{ $pdf_details['responseMessage']  }}</td>
  </tr>
</table>
<hr>
